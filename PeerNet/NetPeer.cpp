...
namespace PeerNet
{
	...
	const size_t NetPeer::CompressPacket(SendPacket*const OUT_Packet, PCHAR DataBuffer, const size_t& MaxDataSize, ZSTD_CCtx*const CCtx)
	{
	...
	void NetPeer::Receive_Packet(const u_short& TypeID, const PCHAR IncomingData, const size_t& DataSize, const size_t& MaxDataSize, char*const CBuff, ZSTD_DCtx*const DCtx )
	{
